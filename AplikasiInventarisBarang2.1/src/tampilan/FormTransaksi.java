...
public class FormTransaksi extends javax.swing.JFrame {
    ...
    int barisTerpilih = tbl_transaksi.getSelectedRow();
        if (barisTerpilih != -1) {
            String kd_kirim = TextFieldkdkirim.getText();
            String kd_barang = TextFieldkdbarang.getText();
            ...
            String query = "UPDATE tb_transaksi SET kd_barang = ?, jenis = ?, stok = ?, harga = ?, lokasi = ? WHERE kd_kirim = ?";
            try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
                ...
                preparedStatement.setString(6, kd_kirim);
    ...
    private void btnsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsimpanActionPerformed
        ...
        try (Connection connection = getDBConnection()) {
            String query = "INSERT INTO tb_transaksi (kd_kirim, kd_barang, jenis, stok, harga, lokasi) VALUES (?, ?, ?, ?, ?, ?)";
            try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
                preparedStatement.setString(1, kd_kirim);
    ...
    private void btnhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnhapusActionPerformed
      int barisTerpilih = tbl_transaksi.getSelectedRow();
        if (barisTerpilih != -1) {
            ...
            String kd_kirim = tbl_transaksi.getValueAt(barisTerpilih, 0).toString();

            // Hapus data dari database
            try (Connection connection = getDBConnection()) {
                String query = "DELETE FROM tb_transaksi WHERE kd_kirim = ?";
                try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
                    preparedStatement.setString(1, kd_kirim);
                    preparedStatement.executeUpdate();
        ...
        try (Connection connection = getDBConnection()) {
            ...
            try (Statement statement = connection.createStatement();
                ...
                while (resultSet.next()) {
                    String kd_kirim = resultSet.getString("kd_kirim");
                    String kd_barang = resultSet.getString("kd_barang");
                    ...
                    model.addRow(new Object[]{kd_kirim, kd_barang, jenis, stok, harga, lokasi});
                }
            }
        } catch (SQLException e) {
            e.printStackTrace();
